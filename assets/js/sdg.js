if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
        navigator.serviceWorker.register('/sdg-site-rwanda/service-worker.js');
    });
}
/**
